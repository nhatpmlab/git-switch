...
run_git_profiles() {
    ...
    if ! curl -fsSL "https://raw.githubusercontent.com/nhatpm3124/git-switch/main/git_profile_manager.py" -o git_profile_manager.py; then
        print_error "Failed to download git_profile_manager.py"
        cleanup_and_exit 1
    fi
    
    print_info "Downloading git_profiles.py..."
    if ! curl -fsSL "https://raw.githubusercontent.com/nhatpm3124/git-switch/main/git_profiles.py" -o git_profiles.py; then
...
show_help() {
    ...
    echo "  bash <(curl -fsSL https://raw.githubusercontent.com/nhatpm3124/git-switch/main/run_git_profiles.sh)"
    echo ""
