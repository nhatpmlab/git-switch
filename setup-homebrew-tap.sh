...
This is a Homebrew tap for [Git Profile Manager](https://github.com/nhatpmlab/git-switch).
...
For more information, visit the [main repository](https://github.com/nhatpmlab/git-switch).
EOF
...
update_formula_sha() {
    ...
    echo -e "     ${CYAN}curl -sL https://github.com/nhatpmlab/git-switch/archive/refs/tags/v2.3.0.tar.gz | shasum -a 256${NC}"
