...
function Write-Header {
    ...
    Write-Host "║               Git Profile Manager v2.0                      ║" -ForegroundColor Cyan
...
function Start-GitProfiles {
    ...
    try {
        ...
        try {
            Invoke-WebRequest -Uri "https://raw.githubusercontent.com/nhatpm3124/git-switch/main/git_profile_manager.py" -OutFile "git_profile_manager.py"
        } catch {
        ...
        try {
            Invoke-WebRequest -Uri "https://raw.githubusercontent.com/nhatpm3124/git-switch/main/git_profiles.py" -OutFile "git_profiles.py"
        } catch {
...
function Show-Help {
    ...
    Write-Host "  iwr -useb https://raw.githubusercontent.com/nhatpm3124/git-switch/main/run_git_profiles.ps1 | iex"
    Write-Host ""
    Write-Host "  # Or save and run locally:"
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/nhatpm3124/git-switch/main/run_git_profiles.ps1' -OutFile 'run_git_profiles.ps1'"
...
if ($Install) {
    ...
    iwr -useb https://raw.githubusercontent.com/nhatpm3124/git-switch/main/install.sh | bash
    exit $LASTEXITCODE
}
